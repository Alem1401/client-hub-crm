        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Notes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    InsuranceType = table.Column<string>(type: "nvarchar(13)", maxLength: 13, nullable: false),
                    ...
                    RegistrationPlate = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    ProductionYear = table.Column<int>(type: "int", nullable: true),
                    PowerKw = table.Column<int>(type: "int", nullable: true),
                    EngineCcm = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Insurances_Agents_AgentId",
                        column: x => x.AgentId,
                        principalTable: "Agents",
                        principalColumn: "Id",
